...
function getWinnersByYear(array, getFinalsCB, getYearsCB, getWinnersCB) {
    ...
    const finalYears = getYearsCB(array, getFinalsCB)
    return winners.map((item, index) => `In ${finalYears[index]}, ${item} won the world cup!`)
}
...
function getAverageGoals(getFinalsCB) {
   const totalGoals = getFinalsCB.reduce((acc, item) => acc + item['Home Team Goals'] + item['Away Team Goals'], 0);
